        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="page-hero bg-image overlay-dark" style="background-image: url(../admin/img/pill.jpg); background-repeat:no-repeat;background-size:cover;height:20%">
    <div class="hero-section">
      <div class="container text-center wow zoomIn">
          <br>
        <span class="subhead" style='color:black'>Let's make it easy</span><br>
        <span class="display-4" style="height:1em;color:black">View Doctors</span>
        <br>
        <br>
        <a href="#" class="btn "></a>
      </div>
         ...
         $s=mysqli_query($con,"select * from dregister");
	              ...
	              while($row=mysqli_fetch_array($s))
                 {
                    ...
                    echo "<td align='center'>$sno</td>";
                         ...
                         echo "<td><a href='deldoc.php?a=$row[0]'><img src='img/delete.png'   style='width:1.45em;height:1.45em;'></a></td>";
                         echo "</tr>";
                         $sno++;
					}
