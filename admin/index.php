...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="viewpatient.php">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>View Registered Patients</span></a>
            </li>
	 ...
	 <?php	        
			$connection = mysqli_connect("localhost", "root", "", "drconsult");  
     $query="select Id from dregister  order by Id ";
	 $query_run=mysqli_query($connection,$query);
	 $row=mysqli_num_rows($query_run);
	
     $query="select Sno from registrationdetails order by Sno";
	 $query_run1=mysqli_query($connection,$query);
	 $row1=mysqli_num_rows($query_run1);	
			
	 $query="select SNo from medicines order by SNo";
	   ...
	   <div style=''>
	        <div style='display:inline-block;background-color:#f56954;width:250px;height:90px'> 
              <?php
			     ...
			     ?>
				 <span style='color:white;font-size:12px'>&nbsp Total Registered Doctors<span>
			 </div> &nbsp 
			 ...
			 <div style='display:inline-block;;background-color:#00c0ef;width:250px;height:90px'> 
			     ...
			     ?>
				 <span style='color:white;font-size:12px'>&nbsp Total patients<span>
			 </div> &nbsp 
			 <div style='display:inline-block;;background-color:#008080;width:250px;height:90px'> 
	           <?php
			       echo "<h1 style='color:white'>&nbsp $row2</h1>";
			     ?>
				 <span style='color:white;font-size:12px'>&nbsp Total Medicines<span>
			 </div>&nbsp
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="adminlogin/index.php">Logout</a>
                </div>
            </div>
        </div>
    </div>
