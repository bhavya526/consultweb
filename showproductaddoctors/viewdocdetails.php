...
<body>
  ...
  <div class="page-hero bg-image overlay-dark" style="background-image: url(../assets/img/ffd.jpg); height:20%">
    <div class="hero-section">
      <div class="container text-center wow zoomIn">
          <br>
        <span class="subhead">Let's make it easy</span><br>
        <span class="display-4" style="height:1em;">Our doctors</span>
        <br>
        <br>
        <a href="#" class="btn "></a>
      </div>
  ...
  <?php
   ...
   $r=mysqli_query($con,"select * from dregister where regid='$regg'");
