...
<body>
  ...
  <?php
  $_SESSION["disease"]=$_POST["d1"];
  $_SESSION["price"]=$_POST["p1"];
  ?>

  <div class="page-hero bg-image overlay-dark" style="background-image: url(../assets/img/labtest3.jpg);height:100%">
      ...
      <div class="container text-center wow zoomIn">
        ...
        <div class="row mt-5 ">
          ...
          <div class="col-12 col-sm-6 py-2 wow fadeInRight" data-wow-delay="300ms">
             <input type="number" class="form-control" name="pp" placeholder="Phone number">
          </div>
