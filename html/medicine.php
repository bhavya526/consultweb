...
<body>
  ...
  <div class="page-hero bg-image overlay-dark" style="background-image: url(../assets/img/med1.jpg); height:20%">
    <div class="hero-section">
      <div class="container text-center wow zoomIn">
        ...
        <span class="display-4" style="height:1em;">Buy health related products</span>
        <br>
        <br>
        <a href="#" class="btn "></a>
      </div>
  ...
  <div class="page-section bg-light">
    <div class="container">
      <h3 class="wow fadeInUp">Browse your product</h3>
      <div class="row mt-5">
        ...
        <div class="col-lg-4 py-2 wow zoomIn">
          <div class="card-blog">
            <div class="header">
              ...
              <a href="blog-details.html" class="post-thumb">
                <img src="../assets/img/blog/pain.jpg" alt="">
              </a>
            </div>
