        ...
        <div class="card" style="border-radius: 1rem; ">
          <div class="row g-0">
            ...
            <div class="col-md-6 col-lg-7 d-flex align-items-center">
              ...
              <form method="POST" action="dloginvalid.php">
...
<div class="form-outline mb-4">
  <input type="text" id="form2Example17" class="form-control form-control-lg" name="docId" />
  <label class="form-label" for="form2Example17" style="font-size:13px">Registered ID</label>
</div>

<div class="form-outline mb-4">
  <input type="password" id="form2Example27" class="form-control form-control-lg" name="docPwd" />
...
<p class="mb-5 pb-lg-2" style="color: #393f81;">Don't have an account? <a href="drregister.php"
